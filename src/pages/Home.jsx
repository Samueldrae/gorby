  ...
  return (
    <Layout>
      ...
      <section className="relative w-full bg-[url('/img/hero.png')] bg-no-repeat md:bg-cover bg-cover bg-center md:h-[130vh] h-96">
        ...
        <div className="fixed  w-full flex justify-center items-end h-screen md:h-auto md:justify-end p-3 z-50 ">
          <a href='#' className='bg-white border-[8px] border-[#292834] text-[#292834] py-3 px-7 text-3xl md:text-5xl font-londrina hover:scale-90 active:scale-90'>BUY NOW</a>
        </div>
      ...
      <section className="relative w-full h-auto py-24 md:py-52 flex items-center justify-center">
        ...
        <div className="relative w-full max-w-6xl px-4">
          ...
          <div className="absolute top-[30%] left-[8%] w-[50%] h-[30%] flex flex-col lg:hidden items-center space-y-1 sm:space-y-2 justify-center text-center text-white p-4 font-semibold">
            <h2 className="text-3xl sm:text-5xl md:text-6xl font-bold">100B $GORB</h2>
